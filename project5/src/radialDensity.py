...
for N_index, N in enumerate(range(300,401,10)):
...
n0 =  1
r0 =  3.5
ax.plot(plot_r, n0/(1+(plot_r/(r0))**4),label=r'%g/(1+(r/%g)^2)' % (n0,r0))
...
ax.set_ylabel(r'Nummertetthet, $n(r)$',size=23)
ax.legend(prop={'size':16})
dummy.set_xlabel(r'Avstand fra massesenter, [$R_0$]',size=23)
dummy.set_ylabel(r'Partikkeltetthet, $\rho(r)$',size=23)
