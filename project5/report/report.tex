...
i python. Nok en gang har vi fått oppleve viktigheten av grundig testing
...
\pagebreak
  \item[]\lstinputlisting[basicstyle=\small,caption={Tabell som viser
      presisjon og kjøretid (format (presisjon, tid brukt)) for både
      Runge-Kutta 4 og Velocity-Verlet for flere tidsperioder og steglengder.},
