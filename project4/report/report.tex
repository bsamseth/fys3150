...
likevekt. Og selv om vi finner en ideell verdi for denne kan det hende
...
sannsynlige tilstanden. Dette er likevel ikke altfor sannsynlig, så vi
``krysser fingrene'' og håper på det beste.

Ved litt testing fant vi at en grense som så ut til å fungere for alle relevante
temperatur var ca. $10\%$. Vi regner altså system som termalisert
dersom det ikke endrer seg mer enn denne verdien i forhold til et
tidligere tidspunkt.\footnote{Programmet som inneholder termaliserings
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.5]{../fig/critical.png}
