...
\begin{titlepage}
  ...
  \HRule \\[0.4cm]
  { \huge \bfseries En titt på Jacobis metode og noen anvendelser på enkle Schr\"dingerligninger}\\[0.4cm] % Title of your document
  \HRule \\[1.5cm]
...
\]
ender opp med Schr\"dingerligningen
\[
...
Vi kan altså løse begge våre to Schr\"dingerligninger \eqref{eq:SL-rewrite} 
