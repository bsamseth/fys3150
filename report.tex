...
\]
Videre kan vi definere vinkelen $\theta$ slik at de ikke-diagonale elementene i matrisa 
$a_{kl}$ blir null.
...
og $s=tc$.  
Vi velger
$t$ til å være den minste av røttene. Dette forsikrer oss om at $|\theta| \le \pi/4$) og minimerer derfor differansen mellom${\bf B}$ og ${\bf A}$ siden
\[
